...
public class RequestGroceryListQuery {
    ...
    public List<ItemInformation> URLConnectionRequestGroceryList(Long id, Integer listNo) throws IOException, JSONException, ParseException {
        String json = "{\"query\": \"query { userItems( idUserList: "+id+", ListNo: "+listNo+" ){id, idUserList, ItemName, Quantity, CaloricValue, PurchaseDate, ExpirationDate, ConsumptionDate}}\"}";
